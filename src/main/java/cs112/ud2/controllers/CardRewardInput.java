...
import cs112.ud2.models.DMCard;
import cs112.ud2.models.DMCreature;
...
public class CardRewardInput {
    ...
    public void initializeData(){
        ...
        for(DMCard card: testAllPossibleCards){
    ...
    public void onComboBoxAction(ActionEvent actionEvent){
        ...
        if(actionEvent.getSource().equals(cardRewardComboBox1)){
            ...
            if(comboBoxAutocomplete(currentBox)){
                cardRewardComboBox2.requestFocus();
            }
            try{
                ...
                if(idNum>-1){
                    String filepath = "/cs112/ud2/cardImages/"+selection+".png";
                    ...
                    card1image.setImage(newImage);
                    selectedCards[0] = currentCard;
                }
            ...
            currentBox = cardRewardComboBox2;
            if(comboBoxAutocomplete(currentBox)){
                cardRewardComboBox3.requestFocus();
            }
            try {
                DMCard currentCard = currentBox.getSelectionModel().getSelectedItem();
                int idNum = currentCard.getIdNum();
                ...
                if(idNum>-1) {
                    String filepath = "/cs112/ud2/cardImages/"+selection+".png";
                    Image newImage = new Image(getClass().getResourceAsStream(filepath));
                    card2image.setImage(newImage);
                    selectedCards[1] = currentCard;
                }
            }catch (ClassCastException cce){
                System.out.println("Misspelling");
            }
            ...
            try {
                ...
                if(idNum>-1){
                    String filepath = "/cs112/ud2/cardImages/"+selection+".png";
                    Image newImage = new Image(getClass().getResourceAsStream(filepath));
                    card3image.setImage(newImage);
                    selectedCards[2] = currentCard;
                }
            }catch (ClassCastException cce){
                System.out.println("Misspelling on box 3");
            }
    ...
    void onBackClick(ActionEvent actionEvent) throws IOException {
        ...
        Parent opponentInput = FXMLLoader.load(InintialView.class.getResource("opponent-input.fxml"));
    ...
    void onCancelClick(ActionEvent actionEvent) throws IOException{
        ...
        loader.setLocation(InintialView.class.getResource("cancel-confirmation.fxml"));
    ...
    void  onNextClick(ActionEvent actionEvent) throws  IOException{
        ...
        FXMLLoader loader = new FXMLLoader();
        loader.setLocation(InintialView.class.getResource("stats-input.fxml"));
